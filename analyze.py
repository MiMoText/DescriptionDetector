...
if __name__ == '__main__':
    ...
    create_plot('density (range=3,same_paragraph=False)', df_example, 'examples/plot_r3.png')
    create_plot('density (range=5,same_paragraph=False)', df_example, 'examples/plot_r5.png')
    create_boxplot('density (range=3,same_paragraph=False)', df_example, 'examples/boxplot_r3.png')
    create_plot(header_sentence_perc, df_example, 'examples/plot.png')
    create_boxplot(header_sentence_perc, df_example, 'examples/boxplot.png')
    print(df_example)